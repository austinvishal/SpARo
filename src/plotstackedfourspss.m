function plotstackedfourspss(A_i1,A_i2,A_i3,A_i4,b1,b2,b3,b4,r1,r2,r3,r4,delta_1,delta_2,delta_3,delta_4,delta_5,center_plat,O,alpha,beta,lambda,o_i,r_o)
%n10 base
% n11 -n20
% n21 n30
% n31 terminal
...
hold on
%platform square
xp_b= [b2(1) b2(1) b3(1) b4(1)];% here triangle is formed with three unique vertices, other three points are same here otherwise need to plot polygon
